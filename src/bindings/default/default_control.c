...
/* ------------------------------------------------------------ */
/* Main description of the location */
...
/* Ability to change the text of the main description */
...
/* ------------------------------------------------------------ */
/* Menu */
/* The function is intended only for calling from the QSP_CALL_SHOW MENU callback */
