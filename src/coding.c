...
char16_t qspKOI8RToUnicodeTable[] =
{
...
char16_t qspCP1251ToUnicodeTable[] =
{
...
inline char16_t qspDirectConvertUC(char, char16_t *);
inline char qspReverseConvertUC(char16_t, char16_t *);
...
static wchar_t qspDirectConvertUC(char ch, char16_t *table)
{
	unsigned char ch2 = (unsigned char)ch;
	return (ch2 >= 0x80 ? table[ch2 - 0x80] : ch);
}

static char qspReverseConvertUC(char16_t ch, char16_t *table)
{
	int i;
